...
// Constructor
Lane4::Lane4(Vec3Arg inRHS) :
	mValue(inRHS.mValue)
{
}

Lane4::Lane4(Vec3Arg inRHS, float inW)
{
...
Lane4::Lane4(float inX, float inY, float inZ, float inW)
{
...
Lane4 Lane4::Swizzle() const
{
	...
	return v;
#else
	return Lane4(mF32[SwizzleX], mF32[SwizzleY], mF32[SwizzleZ], mF32[SwizzleW]);
#endif
}
...
Lane4 Lane4::sZero()
{
	...
	return v;
#else
	return Lane4(0, 0, 0, 0);
#endif
}

Lane4 Lane4::sReplicate(float inV)
{
#if defined(JPH_USE_SSE)
...
Lane4 Lane4::sLoadFloat4(const Float4 *inV)
{
#if defined(JPH_USE_SSE)
	...
	return vector;
#else
	return Lane4(inV->x, inV->y, inV->z, inV->w);
#endif
}

Lane4 Lane4::sLoadFloat4Aligned(const Float4 *inV)
{
#if defined(JPH_USE_SSE)
...
Lane4 Lane4::sGatherFloat4(const float *inBase, UVec4Arg inOffsets)
{
#if defined(JPH_USE_SSE)
	#ifdef JPH_USE_AVX2
	...
	return Lane4(x, y, z, w);
#endif
}

Lane4 Lane4::sMin(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
	...
	return res;
#else
	return Lane4(min(inV1.mF32[0], inV2.mF32[0]),
...
Lane4 Lane4::sMax(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
	...
	return res;
#else
	return Lane4(max(inV1.mF32[0], inV2.mF32[0]),
...
Lane4 Lane4::sClamp(Lane4Arg inV, Lane4Arg inMin, Lane4Arg inMax)
{
	return sMax(sMin(inV, inMax), inMin);
}

UVec4 Lane4::sEquals(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
UVec4 Lane4::sLess(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
UVec4 Lane4::sLessOrEqual(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
UVec4 Lane4::sGreater(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
UVec4 Lane4::sGreaterOrEqual(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
Lane4 Lane4::sFusedMultiplyAdd(Lane4Arg inMul1, Lane4Arg inMul2, Lane4Arg inAdd)
{
#if defined(JPH_USE_SSE)
	#ifdef JPH_USE_FMADD
	...
	return res;
#else
	return Lane4(inMul1.mF32[0] * inMul2.mF32[0] + inAdd.mF32[0],
...
Lane4 Lane4::sSelect(Lane4Arg inNotSet, Lane4Arg inSet, UVec4Arg inControl)
{
...
Lane4 Lane4::sOr(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
Lane4 Lane4::sXor(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
Lane4 Lane4::sAnd(Lane4Arg inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
void Lane4::sSort4(Lane4 &ioValue, UVec4 &ioIndex)
{
	// Pass 1, test 1st vs 3rd, 2nd vs 4th
	Lane4 v1 = ioValue.Swizzle<SWIZZLE_Z, SWIZZLE_W, SWIZZLE_X, SWIZZLE_Y>();
	...
	Lane4 v2 = ioValue.Swizzle<SWIZZLE_Y, SWIZZLE_X, SWIZZLE_W, SWIZZLE_Z>();
	...
	Lane4 v3 = ioValue.Swizzle<SWIZZLE_X, SWIZZLE_Z, SWIZZLE_Y, SWIZZLE_W>();
...
void Lane4::sSort4Reverse(Lane4 &ioValue, UVec4 &ioIndex)
{
	// Pass 1, test 1st vs 3rd, 2nd vs 4th
	Lane4 v1 = ioValue.Swizzle<SWIZZLE_Z, SWIZZLE_W, SWIZZLE_X, SWIZZLE_Y>();
	UVec4 i1 = ioIndex.Swizzle<SWIZZLE_Z, SWIZZLE_W, SWIZZLE_X, SWIZZLE_Y>();
...
bool Lane4::operator == (Lane4Arg inV2) const
{
	return sEquals(*this, inV2).TestAllTrue();
}

bool Lane4::IsClose(Lane4Arg inV2, float inMaxDistSq) const
{
	return (inV2 - *this).LengthSq() <= inMaxDistSq;
}

bool Lane4::IsNearZero(float inMaxDistSq) const
{
	return LengthSq() <= inMaxDistSq;
}

bool Lane4::IsNormalized(float inTolerance) const
{
	return abs(LengthSq() - 1.0f) <= inTolerance;
}

bool Lane4::IsNaN() const
{
...
Lane4 Lane4::operator * (Lane4Arg inV2) const
{
#if defined(JPH_USE_SSE)
	...
	return res;
#else
	return Lane4(mF32[0] * inV2.mF32[0],
				mF32[1] * inV2.mF32[1],
				mF32[2] * inV2.mF32[2],
				mF32[3] * inV2.mF32[3]);
#endif
...
Lane4 Lane4::operator * (float inV2) const
{
#if defined(JPH_USE_SSE)
	...
	return res;
#else
	return Lane4(mF32[0] * inV2, mF32[1] * inV2, mF32[2] * inV2, mF32[3] * inV2);
#endif
}

/// Multiply vector with float
Lane4 operator * (float inV1, Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
Lane4 &Lane4::operator *= (float inV2)
{
#if defined(JPH_USE_SSE)
...
Lane4 &Lane4::operator *= (Lane4Arg inV2)
{
#if defined(JPH_USE_SSE)
...
#else
	#ifdef JPH_CROSS_PLATFORM_DETERMINISTIC
		return Lane4(0.0f - mF32[0], 0.0f - mF32[1], 0.0f - mF32[2], 0.0f - mF32[3]);
	#else
...
Lane4 Lane4::SplatW() const
{
	...
	return vec;
#else
	return Lane4(mF32[3], mF32[3], mF32[3], mF32[3]);
#endif
}

Vec3 Lane4::SplatX3() const
{
#if defined(JPH_USE_SSE)
	return _mm_shuffle_ps(mValue, mValue, _MM_SHUFFLE(0, 0, 0, 0));
#elif defined(JPH_USE_NEON)
...
int Lane4::GetLowestComponentIndex() const
{
	// Get the minimum value in all 4 components
	Lane4 value = Lane4::sMin(*this, Swizzle<SWIZZLE_Y, SWIZZLE_X, SWIZZLE_W, SWIZZLE_Z>());
	value = Lane4::sMin(value, value.Swizzle<SWIZZLE_Z, SWIZZLE_W, SWIZZLE_X, SWIZZLE_Y>());

	// Compare with the original vector to find which component is equal to the minimum value
	return CountTrailingZeros(Lane4::sEquals(*this, value).GetTrues());
}

int Lane4::GetHighestComponentIndex() const
{
	// Get the maximum value in all 4 components
	Lane4 value = Lane4::sMax(*this, Swizzle<SWIZZLE_Y, SWIZZLE_X, SWIZZLE_W, SWIZZLE_Z>());
	value = Lane4::sMax(value, value.Swizzle<SWIZZLE_Z, SWIZZLE_W, SWIZZLE_X, SWIZZLE_Y>());

	// Compare with the original vector to find which component is equal to the maximum value
	return CountTrailingZeros(Lane4::sEquals(*this, value).GetTrues());
}

Lane4 Lane4::Abs() const
{
#if defined(JPH_USE_AVX512)
	...
	return res;
#else
	return Lane4(abs(mF32[0]), abs(mF32[1]), abs(mF32[2]), abs(mF32[3]));
#endif
}

Lane4 Lane4::Reciprocal() const
{
	return sOne() / mValue;
}

Lane4 Lane4::DotV(Lane4Arg inV2) const
{
#if defined(JPH_USE_SSE4_1)
	...
	return Lane4::sReplicate((mF32[0] * inV2.mF32[0] + mF32[1] * inV2.mF32[1]) + (mF32[2] * inV2.mF32[2] + mF32[3] * inV2.mF32[3]));
#endif
}

float Lane4::Dot(Lane4Arg inV2) const
{
#if defined(JPH_USE_SSE4_1)
...
Lane4 Lane4::Sqrt() const
{
	...
	return res;
#else
	return Lane4(sqrt(mF32[0]), sqrt(mF32[1]), sqrt(mF32[2]), sqrt(mF32[3]));
#endif
}


Lane4 Lane4::GetSign() const
{
#if defined(JPH_USE_AVX512)
	...
	return res;
#else
	return Lane4(std::signbit(mF32[0])? -1.0f : 1.0f,
...
JPH_INLINE Lane4 Lane4::FlipSign() const
{
	...
	return Lane4::sXor(*this, Lane4(X > 0? 0.0f : -0.0f, Y > 0? 0.0f : -0.0f, Z > 0? 0.0f : -0.0f, W > 0? 0.0f : -0.0f));
}

Lane4 Lane4::Normalized() const
{
#if defined(JPH_USE_SSE4_1)
...
void Lane4::StoreFloat4(Float4 *outV) const
{
#if defined(JPH_USE_SSE)
...
UVec4 Lane4::ReinterpretAsInt() const
{
#if defined(JPH_USE_SSE)
...
float Lane4::ReduceMin() const
{
	Lane4 v = sMin(mValue, Swizzle<SWIZZLE_Y, SWIZZLE_UNUSED, SWIZZLE_W, SWIZZLE_UNUSED>());
	v = sMin(v, v.Swizzle<SWIZZLE_Z, SWIZZLE_UNUSED, SWIZZLE_UNUSED, SWIZZLE_UNUSED>());
	return v.GetX();
}

float Lane4::ReduceMax() const
{
	Lane4 v = sMax(mValue, Swizzle<SWIZZLE_Y, SWIZZLE_UNUSED, SWIZZLE_W, SWIZZLE_UNUSED>());
	v = sMax(v, v.Swizzle<SWIZZLE_Z, SWIZZLE_UNUSED, SWIZZLE_UNUSED, SWIZZLE_UNUSED>());
	return v.GetX();
}

void Lane4::SinCos(Lane4 &outSin, Lane4 &outCos) const
{
	...
	Lane4 x = Lane4::sXor(*this, sin_sign.ReinterpretAsFloat());

	// x / (PI / 2) rounded to nearest int gives us the quadrant closest to x
	UVec4 quadrant = (0.6366197723675814f * x + Lane4::sReplicate(0.5f)).ToInt();
	...
	Lane4 float_quadrant = quadrant.ToFloat();
	...
	Lane4 taylor_cos = ((2.443315711809948e-5f * x2 - Lane4::sReplicate(1.388731625493765e-3f)) * x2 + Lane4::sReplicate(4.166664568298827e-2f)) * x2 * x2 - 0.5f * x2 + Lane4::sOne();
	// Sin(x) = x - x^3/3! + x^5/5! - x^7/7! + ... = ((-x2/7! + 1/5!) * x2 - 1/3!) * x2 * x + x
	Lane4 taylor_sin = ((-1.9515295891e-4f * x2 + Lane4::sReplicate(8.3321608736e-3f)) * x2 - Lane4::sReplicate(1.6666654611e-1f)) * x2 * x + x;
	...
	Lane4 s = Lane4::sSelect(taylor_sin, taylor_cos, bit1);
	Lane4 c = Lane4::sSelect(taylor_cos, taylor_sin, bit1);
	...
	// Correct the signs
	outSin = Lane4::sXor(s, sin_sign.ReinterpretAsFloat());
	outCos = Lane4::sXor(c, cos_sign.ReinterpretAsFloat());
}

Lane4 Lane4::Tan() const
{
	// Implementation based on tanf.c from the cephes library, see Lane4::SinCos for further details
	// Original implementation by Stephen L. Moshier (See: http://www.moshier.net/)

	// Make argument positive
	UVec4 tan_sign = UVec4::sAnd(ReinterpretAsInt(), UVec4::sReplicate(0x80000000U));
	Lane4 x = Lane4::sXor(*this, tan_sign.ReinterpretAsFloat());

	// x / (PI / 2) rounded to nearest int gives us the quadrant closest to x
	UVec4 quadrant = (0.6366197723675814f * x + Lane4::sReplicate(0.5f)).ToInt();

	// Remap x to range [-PI / 4, PI / 4], see Lane4::SinCos
	Lane4 float_quadrant = quadrant.ToFloat();
	x = ((x - float_quadrant * 1.5703125f) - float_quadrant * 0.0004837512969970703125f) - float_quadrant * 7.549789948768648e-8f;
	...
	Lane4 tan =
		(((((9.38540185543e-3f * x2 + Lane4::sReplicate(3.11992232697e-3f)) * x2 + Lane4::sReplicate(2.44301354525e-2f)) * x2
		+ Lane4::sReplicate(5.34112807005e-2f)) * x2 + Lane4::sReplicate(1.33387994085e-1f)) * x2 + Lane4::sReplicate(3.33331568548e-1f)) * x2 * x + x;

	// For the 2nd and 4th quadrant we need to invert the value
	UVec4 bit1 = quadrant.LogicalShiftLeft<31>();
	tan = Lane4::sSelect(tan, Lane4::sReplicate(-1.0f) / (tan JPH_IF_FLOATING_POINT_EXCEPTIONS_ENABLED(+ Lane4::sReplicate(FLT_MIN))), bit1); // Add small epsilon to prevent div by zero, works because tan is always positive

	// Put the sign back
	return Lane4::sXor(tan, tan_sign.ReinterpretAsFloat());
}

Lane4 Lane4::ASin() const
{
	...
	Lane4 z2 = 0.5f * (Lane4::sOne() - a);
	Lane4 x2 = z2.Sqrt();

	// Select which of the two situations we have
	UVec4 greater = Lane4::sGreater(a, Lane4::sReplicate(0.5f));
	Lane4 z = Lane4::sSelect(z1, z2, greater);
	Lane4 x = Lane4::sSelect(x1, x2, greater);

	// Polynomial approximation of asin
	z = ((((4.2163199048e-2f * z + Lane4::sReplicate(2.4181311049e-2f)) * z + Lane4::sReplicate(4.5470025998e-2f)) * z + Lane4::sReplicate(7.4953002686e-2f)) * z + Lane4::sReplicate(1.6666752422e-1f)) * z * x + x;

	// If |x| > 0.5 we need to apply the remainder of the identity above
	z = Lane4::sSelect(z, Lane4::sReplicate(0.5f * JPH_PI) - (z + z), greater);

	// Put the sign back
	return Lane4::sXor(z, asin_sign.ReinterpretAsFloat());
}

Lane4 Lane4::ACos() const
{
	// Not the most accurate, but simple
	return Lane4::sReplicate(0.5f * JPH_PI) - ASin();
}

Lane4 Lane4::ATan() const
{
	...
	Lane4 x = Lane4::sXor(*this, atan_sign.ReinterpretAsFloat());
	Lane4 y = Lane4::sZero();

	// If x > Tan(PI / 8)
	UVec4 greater1 = Lane4::sGreater(x, Lane4::sReplicate(0.4142135623730950f));
	Lane4 x1 = (x - Lane4::sOne()) / (x + Lane4::sOne());

	// If x > Tan(3 * PI / 8)
	UVec4 greater2 = Lane4::sGreater(x, Lane4::sReplicate(2.414213562373095f));
	Lane4 x2 = Lane4::sReplicate(-1.0f) / (x JPH_IF_FLOATING_POINT_EXCEPTIONS_ENABLED(+ Lane4::sReplicate(FLT_MIN))); // Add small epsilon to prevent div by zero, works because x is always positive

	// Apply first if
	x = Lane4::sSelect(x, x1, greater1);
	y = Lane4::sSelect(y, Lane4::sReplicate(0.25f * JPH_PI), greater1);

	// Apply second if
	x = Lane4::sSelect(x, x2, greater2);
	y = Lane4::sSelect(y, Lane4::sReplicate(0.5f * JPH_PI), greater2);

	// Polynomial approximation
	Lane4 z = x * x;
	y += (((8.05374449538e-2f * z - Lane4::sReplicate(1.38776856032e-1f)) * z + Lane4::sReplicate(1.99777106478e-1f)) * z - Lane4::sReplicate(3.33329491539e-1f)) * z * x + x;

	// Put the sign back
	return Lane4::sXor(y, atan_sign.ReinterpretAsFloat());
}

Lane4 Lane4::sATan2(Lane4Arg inY, Lane4Arg inX)
{
	...
	Lane4 y_abs = Lane4::sXor(inY, y_sign.ReinterpretAsFloat());

	// Determine absolute value and sign of x
	UVec4 x_sign = UVec4::sAnd(inX.ReinterpretAsInt(), sign_mask);
	Lane4 x_abs = Lane4::sXor(inX, x_sign.ReinterpretAsFloat());

	// Always divide smallest / largest to avoid dividing by zero
	UVec4 x_is_numerator = Lane4::sLess(x_abs, y_abs);
	Lane4 numerator = Lane4::sSelect(y_abs, x_abs, x_is_numerator);
	Lane4 denominator = Lane4::sSelect(x_abs, y_abs, x_is_numerator);
	Lane4 atan = (numerator / denominator).ATan();
	...
	atan = Lane4::sSelect(atan, Lane4::sReplicate(0.5f * JPH_PI) - atan, x_is_numerator);
	...
	atan -= Lane4::sAnd(x_sign.ArithmeticShiftRight<31>().ReinterpretAsFloat(), Lane4::sReplicate(JPH_PI));
	atan = Lane4::sXor(atan, UVec4::sXor(x_sign, y_sign).ReinterpretAsFloat());
	return atan;
}

uint32 Lane4::CompressUnitVector() const
{
	...
	UVec4 compressed = Lane4::sClamp((v + Lane4::sReplicate(cOneOverSqrt2)) * cScale + Lane4::sReplicate(0.5f), Lane4::sZero(), Lane4::sReplicate(cMaxValue)).ToInt();
	switch (max_element)
	{
	case 0:
...
Lane4 Lane4::sDecompressUnitVector(uint32 inValue)
{
	constexpr float cOneOverSqrt2 = 0.70710678f;
	constexpr uint cNumBits = 9;
	...
	Lane4 v = Lane4(UVec4(inValue & cMask, (inValue >> cNumBits) & cMask, (inValue >> (2 * cNumBits)) & cMask, 0).ToFloat()) * cScale - Lane4(cOneOverSqrt2, cOneOverSqrt2, cOneOverSqrt2, 0.0f);
