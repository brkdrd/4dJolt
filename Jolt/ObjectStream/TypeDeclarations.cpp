...
JPH_IMPLEMENT_RTTI_OUTSIDE_CLASS(DVec4)			{ }
...
JPH_IMPLEMENT_RTTI_OUTSIDE_CLASS(Rotor)			{ }
JPH_IMPLEMENT_RTTI_OUTSIDE_CLASS(Bivec)			{ }
...
{
	JPH_ADD_ATTRIBUTE(Plane, mNormal)
	JPH_ADD_ATTRIBUTE(Plane, mConstant)
}
